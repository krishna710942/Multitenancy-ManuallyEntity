...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(String userName, String userEmailId) {
        return doGenerateToken(userName, userEmailId);
    }

    private String doGenerateToken(String subject, String userEmailId) {
        Claims claims = Jwts.claims().setSubject(subject).setAudience(userEmailId);
